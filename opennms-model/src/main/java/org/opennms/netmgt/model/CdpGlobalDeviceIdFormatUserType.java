...
public class CdpGlobalDeviceIdFormatUserType extends EnumType {
     ...
     */
    public CdpGlobalDeviceIdFormatUserType() {}
    ...
    public Object nullSafeGet(ResultSet rs, String[] names, SharedSessionContractImplementor session, Object owner) throws SQLException {
        ...
        for (CdpGlobalDeviceIdFormat type : CdpGlobalDeviceIdFormat.values()) {
            if (type.getValue().intValue() == c.intValue()) {
                return type;
            }
        }
        throw new HibernateException("Invalid value for CdpGlobalDeviceIdFormat: " + c);
    }
    ...
    @Override
    public Class<CdpGlobalDeviceIdFormat> returnedClass() {
        return CdpGlobalDeviceIdFormat.class;
    }
