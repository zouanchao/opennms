...
public class BridgeDot1dBaseTypeUserType extends EnumType {
     ...
     */
    public BridgeDot1dBaseTypeUserType() {}
    ...
    public Object nullSafeGet(ResultSet rs, String[] names, SharedSessionContractImplementor session, Object owner) throws SQLException {
        ...
        for (BridgeDot1dBaseType type : BridgeDot1dBaseType.values()) {
    ...
    public void nullSafeSet(PreparedStatement st, Object value, int index, SharedSessionContractImplementor session) throws HibernateException, SQLException {
        if (value == null) {
            ...
            IntegerType.INSTANCE.nullSafeSet(st, ((BridgeDot1dBaseType)value).getValue(), index, session);
        }
    }

    @Override
    public Class<BridgeDot1dBaseType> returnedClass() {
        return BridgeDot1dBaseType.class;
    }
