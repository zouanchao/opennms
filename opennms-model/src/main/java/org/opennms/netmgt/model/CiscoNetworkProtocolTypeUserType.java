...
public class CiscoNetworkProtocolTypeUserType extends EnumType {
     ...
     */
    public CiscoNetworkProtocolTypeUserType() {}
    ...
    @Override
    public void nullSafeSet(PreparedStatement st, Object value, int index, SharedSessionContractImplementor session) throws HibernateException, SQLException {        if (value == null) {
    ...
    @Override
    public Class<CiscoNetworkProtocolType> returnedClass() {
        return CiscoNetworkProtocolType.class;
    }
