...
public abstract class KarafTestCase {
    ...
    protected Option[] configAsArray() {
        ...
        Option[] options = new Option[]{
            ...
            editConfigurationFilePut("etc/startup.properties", "mvn:net.java.dev.jna/jna/5.1.0", "5"),
            editConfigurationFilePut("etc/startup.properties", "mvn:net.java.dev.jna/jna-platform/5.1.0", "5"),
