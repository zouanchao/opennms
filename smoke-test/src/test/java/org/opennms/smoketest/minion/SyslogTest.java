    ...
    public static final TestEnvironment getTestEnvironment() {
        ...
        try {
            ...
            builder.withOpenNMSEnvironment()
                    ...
                    // Set a queueLength and discardOnFull="false" in eventd-configuration.xml
                    .addFile(SyslogTest.class.getResource("/eventd-configuration.xml"), "etc/eventd-configuration.xml")
