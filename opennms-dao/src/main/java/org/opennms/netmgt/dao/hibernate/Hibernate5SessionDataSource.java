 ...
 */
public class Hibernate5SessionDataSource extends AbstractDataSource {

private static final Logger LOG = LoggerFactory.getLogger(Hibernate5SessionDataSource.class);
 ...
 * Default constructor.
 */
    public Hibernate5SessionDataSource() {
    }

    public Hibernate5SessionDataSource(DataSource target, SessionFactory session) {
    ...
    public Connection getConnection() throws SQLException {
        ...
        if (session == null) {
            ...
            // Wrap the connection in the same code that {@link
            // TransactionAwareDataSourceProxy} uses
    ...
    private class TransactionAwareInvocationHandler implements InvocationHandler {
        ...
        public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
            ...
            if (method.getName().equals("equals")) {
                ...
                // Handle close method: only close if not within a
                // transaction.
            ...
            /*
             * We can comment this out since we're providing the Connection if
             * (this.target == null) { if (this.closed) { throw new
             * SQLException("Connection handle already closed"); } if
             * (shouldObtainFixedConnection(this.targetDataSource)) {
             * this.target =
             * DataSourceUtils.doGetConnection(this.targetDataSource); } }
             */
