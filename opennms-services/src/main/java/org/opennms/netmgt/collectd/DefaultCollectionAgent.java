...
public class DefaultCollectionAgent extends InetNetworkInterface implements SnmpCollectionAgent {
    ...
    public static SnmpCollectionAgent create(final Integer ifaceId, final IpInterfaceDao ifaceDao, final String location) {
        return new DefaultCollectionAgent(DefaultCollectionAgentService.create(ifaceId, ifaceDao), location);
    }
