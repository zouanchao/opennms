...
public interface AlarmEntityNotifier {
    ...
    void didUpdateSticky(OnmsAlarm onmsAlarm, String previousBody, String previousAuthor, Date previousUpdated);

    void didUpdateReductionKeyMemo(OnmsAlarm onmsAlarm, String previousBody, String previousAuthor, Date previousUpdated);

    void didRemoveStickyMemo(OnmsAlarm onmsAlarm, OnmsMemo memo);

    void didRemoveReductionKeyMemo(OnmsAlarm onmsAlarm, OnmsReductionKeyMemo memo);
